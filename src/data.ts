...
const itemQualities: readonly ItemQualityMeta[] = [
    ...
    },
    {
        ...
        title: {
            m: 'незвичайний/непростий/неабиякий/неординарний/особливий/неправдоподібний/славний/гожий/файний/дивний',
            f: 'незвичайна/непроста/неабияка/неординарна/особлива/неправдоподібна/славна/гожа/файна/дивна',
            n: 'незвичайне/непросте/неабияке/неординарне/особливе/неправдоподібне/славне/гоже/файне/дивне',
            x: 'незвичайні/непрості/неабиякі/неординарні/особливі/неправдоподібні/славні/гожі/файні/дивні'
        },
        templates: [
            '{quality-title} {item-title}',
    ...
    },
    {
        ...
        title: {
            m: 'рідкісний/дивовижний/неймовірний/винятковий/немислимий/невидимий/небачений/нечуваний/незрівняний/неперевершений/чудовий',
            f: 'рідкісна/дивовижна/неймовірна/виняткова/немислима/невидима/небачена/нечувана/незрівняна/неперевершена/чудова',
            n: 'рідкісне/дивовижне/неймовірне/виняткове/немислиме/невидиме/небачене/нечуване/незрівняне/неперевершене/чудове',
            x: 'рідкісні/дивовижні/неймовірні/виняткові/немислимі/невидимі/небачені/нечувані/незрівняні/неперевершені/чудові'
        },
        templates: [
            '{quality-title} {item-title}',
